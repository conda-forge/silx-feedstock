...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/silx-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/silx-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1910&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/silx-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.14.____cp314t" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add silx silx-base
# for installing globally
pixi global install silx silx-base
```
...
It is possible to list all of the versions of `silx` available on your platform:
...
```
pixi search silx --channel conda-forge
```
